                    ...
                    <div className="container">
                        <div className="row justify-content-around">
                            ...
                            <div className="card col-lg-5">
                                <div className="card-body">
                                    <h4 className="text-center card-title">
                                        <Link to="/contact" className="card-link text-decoration-none">Knit or Crochet Design</Link>
                                    </h4>
                            ...
                            <div className="card col-lg-5">
                                <div className="card-body">
                                    <h4 className="text-center card-title">
                                        <Link to="/contact" className="card-link text-decoration-none">Teaching</Link>
                                    </h4>
                            ...
                            <div className="card col-lg-5">
                                <div className="card-body">
                                    <h4 className="text-center card-title">
                                        <Link to="/contact" className="card-link text-decoration-none">Sample Knit or Crochet</Link>
                                    </h4>
                            ...
                            <div className="card col-lg-5">
                                <div className="card-body">
                                    <h4 className="text-center card-title">
                                        <Link to="/contact" className="card-link text-decoration-none">Custom Knit or Crochet</Link>
                                    </h4>
                            ...
                            <div className="card col-lg-5">
                                <div className="card-body">
                                    <h4 className="text-center card-title">
                                        <Link to="/contact" className="card-link text-decoration-none">Tech and Copy Editing</Link>
                                    </h4>
                            ...
                            <div className="card col-lg-5">
                                <div className="card-body">
                                    <h4 className="text-center card-title">
                                        <Link to="/contact" className="card-link text-decoration-none">Repair Knit or Crocheted Items</Link>
                                    </h4>
